...
admin.route('/ope/upload', {
    action: function(params,queryParams) {
        if (! Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'adminOpeUpload',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
...
admin.route('/ope/ratings', {
    action: function(params,queryParams) {
        if (! Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'adminOpeRatings',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
...
admin.route('/ope/thresholds', {
    action: function(params,queryParams) {
        if (! Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'adminOpeThresholds',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
