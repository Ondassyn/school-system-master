...
bts.route('/keys/edit/:id', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsKeysEdit20_21',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
...
bts.route('/levels/edit/:id', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsLevelsEdit20_21',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
...
bts.route('/keys/new', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsKeysNew20_21',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
...
bts.route('/levels/new', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsLevelsNew20_21',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
...
bts.route('/ratingByCategory/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsRatingByCategory',menu:'adminMenu'})
...
bts.route('/rating/bonus/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingBonus',menu:'adminMenu'}))
...
bts.route('/ratingByCategory/bonus/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsRatingByCategoryBonus',menu:'adminMenu'})
...
bts.route('/allResults/bonus/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsAllResultsBonus',menu:'adminMenu'}))
...
bts.route('/ratingByQuaility/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingByQuaility',menu:'adminMenu'}))
...
bts.route('/ratingByCount/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingByCount',menu:'adminMenu'}))
...
bts.route('/selector/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsSelector',menu: 'adminMenu'})
...
bts.route('/adminUpload', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'adminBtsUpload',menu:'adminMenu'})
        }
    },
    subscriptions: function(params,queryParams) {
