...
bts.route('/rating/bonus/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingBonus',menu:'schoolMenu'}))
...
bts.route('/ratingByCategory/bonus/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingByCategoryBonus',menu:'schoolMenu'}))
...
bts.route('/results/bonus/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsSchoolResultsBonus',menu:'schoolMenu'}))
...
bts.route('/ratingByQuaility/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingByQuaility',menu:'schoolMenu'}))
...
bts.route('/ratingByCount/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingByCount',menu:'schoolMenu'}))
...
bts.route('/ratingByCategory/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            setTimeout(BlazeLayout.render('mainLayout', {content:'btsRatingByCategory',menu:'schoolMenu'}))
...
bts.route('/selected/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsSelected',menu: 'schoolMenu'})
...
bts.route('/selectedExtra/:btsNo', {
    action: function(params,queryParams) {
        if (!Meteor.userId()) {
            ...
            BlazeLayout.render('mainLayout', {content:'btsSelectedExtra',menu: 'schoolMenu'})
