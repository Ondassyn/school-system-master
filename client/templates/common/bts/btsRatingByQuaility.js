...
import "./btsRatingByQuaility.html";
import { Meteor } from "meteor/meteor";
import XLSX from "xlsx";
Template.btsRatingByQuaility.onCreated(function () {
  let template = this;
  Session.setDefault("Sort", { total: -1 });
  document.title = "БТС Рейтинг Сапамен";
...
var schoolArray2 = [];
Template.btsRatingByQuaility.helpers({
  btsNo() {
...
Template.btsRatingByQuaility.events({
