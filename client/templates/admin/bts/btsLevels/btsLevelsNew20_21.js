        ...
        if(!variantInput.value) {
          ...
          if (gradeNo == "7"){
              if (dayNo == "1" && (btsNo == "1" || btsNo == "2")){
                ...
                answerLevels["mathematicBonus"] = template.find("[name=mathematicBonus]").value;
                answerLevels["kazakh_lang_kazBonus"] = template.find("[name=kazakh_lang_kazBonus]").value;
                answerLevels["kazakh_lang_rusBonus"] = template.find("[name=kazakh_lang_rusBonus]").value;
                answerLevels["geographyBonus"] = template.find("[name=geographyBonus]").value;

                answerLevels["mathematicBonusTopic1"] = template.find("[name=mathematicBonusTopic1]").value;
                answerLevels["kazakh_lang_kazBonusTopic1"] = template.find("[name=kazakh_lang_kazBonusTopic1]").value;
                answerLevels["kazakh_lang_rusBonusTopic1"] = template.find("[name=kazakh_lang_rusBonusTopic1]").value;
                answerLevels["geographyBonusTopic1"] = template.find("[name=geographyBonusTopic1]").value;

                answerLevels["mathematicBonusTopic2"] = template.find("[name=mathematicBonusTopic2]").value;
                answerLevels["kazakh_lang_kazBonusTopic2"] = template.find("[name=kazakh_lang_kazBonusTopic2]").value;
                answerLevels["kazakh_lang_rusBonusTopic2"] = template.find("[name=kazakh_lang_rusBonusTopic2]").value;
                answerLevels["geographyBonusTopic2"] = template.find("[name=geographyBonusTopic2]").value;
              ...
              if (dayNo == "1") {
                ...
                answerLevels["mathematicBonus"] = template.find("[name=mathematicBonus]").value;
                answerLevels["physicsBonus"] = template.find("[name=physicsBonus]").value;
                answerLevels["biologyBonus"] = template.find("[name=biologyBonus]").value;

                answerLevels["mathematicBonusTopic1"] = template.find("[name=mathematicBonusTopic1]").value;
                answerLevels["physicsBonusTopic1"] = template.find("[name=physicsBonusTopic1]").value;
                answerLevels["biologyBonusTopic1"] = template.find("[name=biologyBonusTopic1]").value;

                answerLevels["mathematicBonusTopic2"] = template.find("[name=mathematicBonusTopic2]").value;
                answerLevels["physicsBonusTopic2"] = template.find("[name=physicsBonusTopic2]").value;
                answerLevels["biologyBonusTopic2"] = template.find("[name=biologyBonusTopic2]").value;
              }
              else if(dayNo == "2"){
                answerLevels["geography"] = template.find("[name=geography]").value;
                answerLevels["physics"] = template.find("[name=physics]").value;
            ...
            if (dayNo == "1") {
              ...
              answerLevels["mathematicBonus"] = template.find("[name=mathematicBonus]").value;
              answerLevels["physicsBonus"] = template.find("[name=physicsBonus]").value;
              answerLevels["chemistryBonus"] = template.find("[name=chemistryBonus]").value;

              answerLevels["mathematicBonusTopic1"] = template.find("[name=mathematicBonusTopic1]").value;
              answerLevels["physicsBonusTopic1"] = template.find("[name=physicsBonusTopic1]").value;
              answerLevels["chemistryBonusTopic1"] = template.find("[name=chemistryBonusTopic1]").value;

              answerLevels["mathematicBonusTopic2"] = template.find("[name=mathematicBonusTopic2]").value;
              answerLevels["physicsBonusTopic2"] = template.find("[name=physicsBonusTopic2]").value;
              answerLevels["chemistryBonusTopic2"] = template.find("[name=chemistryBonusTopic2]").value;
              ...
              if (dayNo == "1") {
                ...
                answerLevels["chemistryBonus"] = template.find("[name=chemistryBonus]").value;
                answerLevels["biologyBonus"] = template.find("[name=biologyBonus]").value;
                answerLevels["world_historyBonus"] = template.find("[name=world_historyBonus]").value;
                ...
                answerLevels["chemistryBonusTopic1"] = template.find("[name=chemistryBonusTopic1]").value;
                answerLevels["biologyBonusTopic1"] = template.find("[name=biologyBonusTopic1]").value;
                answerLevels["world_historyBonusTopic1"] = template.find("[name=world_historyBonusTopic1]").value;
                ...
                answerLevels["chemistryBonusTopic2"] = template.find("[name=chemistryBonusTopic2]").value;
                answerLevels["biologyBonusTopic2"] = template.find("[name=biologyBonusTopic2]").value;
                answerLevels["world_historyBonusTopic2"] = template.find("[name=world_historyBonusTopic2]").value;
              }
          }
