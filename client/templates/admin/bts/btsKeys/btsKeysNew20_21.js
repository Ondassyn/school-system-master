    ...
    if (!variantInput.value) {
      ...
      if (gradeNo == "7") {
        if (dayNo == "1" && (btsNo == "1" || btsNo == "2" || btsNo == "3")) {
          ...
          // answerKeys["mathematicBonus"] = template.find(
          //   "[name=mathematicBonus]"
          // ).value;
          // answerKeys["kazakh_lang_kazBonus"] = template.find(
          //   "[name=kazakh_lang_kazBonus]"
          // ).value;
          // answerKeys["kazakh_lang_rusBonus"] = template.find(
          //   "[name=kazakh_lang_rusBonus]"
          // ).value;
          // answerKeys["geographyBonus"] = template.find(
          //   "[name=geographyBonus]"
          // ).value;
        }
        // else if (btsNo == "3") {
        ...
        if (dayNo == "1") {
          ...
          //   "[name=mathematicBonus]"
          // ).value;
          // answerKeys["physicsBonus"] = template.find(
          //   "[name=physicsBonus]"
          // ).value;
          // answerKeys["biologyBonus"] = template.find(
          //   "[name=biologyBonus]"
          // ).value;
        }
        // else if(dayNo == "2"){
        ...
        if (dayNo == "1") {
          ...
          //   "[name=physicsBonus]"
          // ).value;
          // answerKeys["chemistryBonus"] = template.find(
          //   "[name=chemistryBonus]"
          // ).value;
        }
        // else if(dayNo == "2"){
        ...
        if (dayNo == "1") {
          ...
          //   "[name=biologyBonus]"
          // ).value;
          // answerKeys["world_historyBonus"] = template.find(
