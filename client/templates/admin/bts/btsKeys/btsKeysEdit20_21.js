...
Template.btsKeysEdit20_21.helpers({
    ...
    mathKeysStore(){
      ...
      if(schoolStore.get("kazakh_lang_kaz"))  kazakh_lang_keys_kaz = schoolStore.get("kazakh_lang_kaz").split("");
      if(schoolStore.get("kazakh_lang_rus"))  kazakh_lang_keys_rus = schoolStore.get("kazakh_lang_rus").split("");
          ...
          if (keys.day == "1" && (keys.quarter == "1" || keys.quarter == "2")){
            ...
            for(var i = 1; i <= mathematic_keys.length; i++){
              if(i == 1){
                ...
                answerKeys["kazakh_lang_kaz"]  = template.find("[id=kazakh_lang_kaz"+i+"]").value
                answerKeys["kazakh_lang_rus"]  = template.find("[id=kazakh_lang_rus"+i+"]").value
