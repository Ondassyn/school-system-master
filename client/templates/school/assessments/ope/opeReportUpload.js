...
Template.opeReportUpload.onCreated(function () {
  ...
  template.reportPeriod = new ReactiveVar("1");
...
Template.opeReportUpload.events({
  ...
  "click #dnload"() {
    ...
    var reportNameList = [
      "Мұғалім түсіндірген сабақ сағаты",
    ...
    data.push([
      "Олимпиада Дайындық Емтиханы(OPE) жасалды",
      "0 - жоқ",
      "1 - exam",
      "2 - exam + uploaded",
    ]);
    data.push([
      "3 күн олимпиада дайындық камп жасалды ма?",
      "0 - жоқ",
      "1 - иә",
    ]);
  ...
  "change #upload"(event, template) {
    ...
    let recordInDb = OpeReports.findOne({
      academicYear: academicYear.get(),
      schoolId: school.schoolId,
      reportPeriod: template.reportPeriod.get(),
    });
