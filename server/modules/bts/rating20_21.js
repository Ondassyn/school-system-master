        ...
        if (ratingObj.grade == '7'){
            if (firstDayCounter != 0) {
              ...
              ratingObj.mathematicBonusB = (ratingObj.mathematicBonusB / firstDayCounter)
                ...
                ratingObj.total += (ratingObj.mathematic + ratingObj.kazakh_lang + ratingObj.geography)/count/20*100
                ratingObj.totalBonus += (ratingObj.mathematicBonus + ratingObj.kazakh_langBonus + ratingObj.geographyBonus)/count/5*100
